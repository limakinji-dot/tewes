    ...
    >
      ...
      <div
        ...
        style={{
          ...
          filter: "blur(60px)",
          opacity: 0.12,
          animation: "blob 24s infinite alternate-reverse",
        }}
      />
      <div
        className="absolute -bottom-[10%] left-[20%] w-[50vw] h-[50vw] rounded-full"
        style={{
          background: "radial-gradient(circle, #0891b2 0%, transparent 70%)",
          filter: "blur(50px)",
          opacity: 0.1,
          animation: "blob 22s infinite alternate",
        }}
      />
      {/* Static noise — tanpa animasi */}
      <div
